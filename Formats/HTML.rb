...
module Webize
  module HTML
    ...
    def self.clean doc, base
      ...
      doc.css('script').map{|s| s.remove if s.inner_text.match? /chartbeat|doubleclick|ensighten|facebook\.(com|net)|google.?[at]|krxd|marketo|ml314|mpulse|newrelic|scorecard|taboola/i}
