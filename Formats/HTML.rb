      ...
      HTML.render ["<!DOCTYPE html>\n",
                   {_: :html,
                    c: [{_: :head,
                        ...
                        {_: :body,
                         c: [{class: :toolbox,
                              c: [(icon.cachePath.exist? && icon.cachePath.node.size != 0) ? {_: :a, href: '/', id: :host, c: {_: :img, src: icon.uri}} : hostname.split('.').-(%w(com net org www)).reverse.map{|h| {_: :a, class: :breadcrumb, href: '/', c: h}},
