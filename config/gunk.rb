...
\.(eot|(bmp|gif)\?|otf|ttf|woff2?))xi
    ...
    ScriptGunk = /algolia|aswpsdkus|auction|bidder|BOOMR|campaign|chartbeat|cloudfront|\.cookie|detroitchicago|doubleclick|ensighten|Ezoic|facebook\.(com|net)|google.?[ast]|gtag|impression|krxd|marketo|media\.net|ml314|mpulse|narrativ\.|newrelic|newsletter|omap[pi]|outbrain|pixel|porpoiseant|prebid|pubmatic|quora|salesloft|scorecard|ta(boola|rget[a-z])|tiqcdn|track(er|ing)|twitter.com|quant(cast|serv)|yandex/i
