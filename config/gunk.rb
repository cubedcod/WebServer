...
class WebResource
  module URIs
    ...
    ScriptGunk = %r([-._\/\(\)'"\s:?&=~%](6sc|acsbapp?|ad(miral|s)?|aksb|b0e8|d([fm]p(xs)?)|en25|fyre|g(aq|t(ag|m))|kr(ux|xd)|licdn|m(ar(insm|keto)|pulse)|nr-data|o(mtrdc|penx)|paq|s(hare[a-z]*|umo)|t(aw|rac)k[a-z]*|turnto|zqtk)[-._\/\(\)'"\s:?&=~%]|
