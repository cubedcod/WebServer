...
ma(rfeel|tomo|ven\.io)|me(dia\.net|quoda)|ml314|mouseflow|mxpnl|
...
ta(boola|rgeting)|tempest|ti(qcdn|nypass)|thinglink|toutapp|tr(ack(cmp|er|ing)|iplelift|ustpilot)|platform.twitter|typekit|
unruly|usabilla|
