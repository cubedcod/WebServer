...
ad(.?bl(ade|ock)|push|r(ecover|oll)|sense|vert)|am(azon|plitude)|acsb|addtoany|algolia|analytic|aswpsdk|auction|
...
narrativ\.|newrelic|newsletter|notif[iy]|npttech|nreum|
