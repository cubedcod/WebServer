...
(custom-theme-set-faces
 ...
 '(font-lock-string-face ((t (:background "dark turquoise" :foreground "black" :slant italic))))
 ...
 '(default ((t (:stipple nil :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 108 :width normal)))))
